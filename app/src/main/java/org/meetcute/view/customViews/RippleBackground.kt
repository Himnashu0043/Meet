...
class RippleBackground : RelativeLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        rippleColor = typedArray.getColor(
            ...
            resources.getColor(R.color.primaryOne)
        )
        ...
        for (i in 0 until rippleAmount) {
            ...
            scaleXAnimator.interpolator = OvershootInterpolator()
            ...
            scaleYAnimator.interpolator = OvershootInterpolator()
            ...
            alphaAnimator.interpolator = OvershootInterpolator()
